...
//1.1 - Notice that even multer is a middleware we don't use the usual (req,res,next) format since it's a "ready to use middleware", not originally built within our project
